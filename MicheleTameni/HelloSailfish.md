...
Go on clicking next and fill in the project summary and description.
...
The Application Window is the top-level element of all Sailfish Silica app. It sets up the initial page to show when the app starts and also defines the Cover to be displayed when app is pushed in the background.
...
Press the green _play_ button to compile and run the project. The first time you'll be asked to start the Mer build machine and the emulator, click "Yes" and wait for the emulator to pop ups and your app to starts.
